package videostremingfragsdatabingrecycler.com.videostremingfragsdatabingrecycler;
...
import videostremingfragsdatabingrecycler.com.videostremingfragsdatabingrecycler.base.HomeInterface;
import videostremingfragsdatabingrecycler.com.videostremingfragsdatabingrecycler.databinding.ActivityMainBinding;
import videostremingfragsdatabingrecycler.com.videostremingfragsdatabingrecycler.frags.Frag2;
import videostremingfragsdatabingrecycler.com.videostremingfragsdatabingrecycler.frags.HomeFragment;
import videostremingfragsdatabingrecycler.com.videostremingfragsdatabingrecycler.model.DrawerItem;
...
if(withAnimation){
    ...
    public void onClick(View v) {
        try {
            ...
            } else if (v == activityMainBinding.laytAbout.laytMenu) {

                Toast.makeText(getApplicationContext(),"frag2",Toast.LENGTH_SHORT).show();
                setDrawerFrag(new Frag2());
